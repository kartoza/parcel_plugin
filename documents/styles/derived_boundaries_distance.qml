...
<qgis version="2.18.10" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="start_x">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{c41864fc-593e-4b5c-9e25-755cbda7c198}">
      <rule key="{e1333f8a-38b6-4fcb-8dff-f5c5dfd59206}" symbol="0"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{e5e68418-afcb-4d92-b133-77478b5c8cad}">
      <rule description="Bearings" key="{8c76858e-b77a-4803-b89a-d16d4d28141e}">
        <settings>
          <text-style fontItalic="1" fontFamily="Ubuntu" fontLetterSpacing="0" fontUnderline="0" fontWeight="63" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,170,255,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="11" fieldName=" &quot;distance&quot;  ||'m'" namedStyle="Medium Italic" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          ...
          <placement repeatDistanceUnit="1" placement="2" maxCurvedCharAngleIn="25" repeatDistance="0" distInMapUnits="0" labelOffsetInMapUnits="1" xOffset="0" distMapUnitScale="0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="0,0,0,0,0,0" centroidWhole="0" priority="5" yOffset="0" offsetType="0" placementFlags="12" centroidInside="0" dist="0" angleOffset="0" maxCurvedCharAngleOut="-25" fitInPolygonOnly="0" quadOffset="4" labelOffsetMapUnitScale="0,0,0,0,0,0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value=" &quot;distance&quot;  || 'm'"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="start_x"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="start_x" expression=""/>
  </defaults>
