  ...
  <labeling type="rule-based">
    <rules key="{4320f27f-f4df-4e03-9d1a-11f329b12751}">
      <rule description="Degrees" key="{efbeb8fc-e4f5-470f-b608-b3963fcb38fc}">
        <settings>
          <text-style fontItalic="1" fontFamily="Ubuntu" fontLetterSpacing="0" fontUnderline="0" fontWeight="63" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,170,255,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="11" fieldName=" to_int( bearing )||'°'" namedStyle="Medium Italic" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
