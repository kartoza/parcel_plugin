...
<qgis styleCategories="AllStyleCategories" version="3.16.2-Hannover" minScale="1e+08" readOnly="0" maxScale="0" hasScaleBasedVisibilityFlag="0">
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field name="instrument_cat" configurationFlags="None">
  ...
  <aliases>
    <alias field="instrument_cat" name="" index="0"/>
    <alias field="description" name="Description" index="1"/>
  </aliases>
  <defaults>
    <default expression="" applyOnUpdate="0" field="instrument_cat"/>
    <default expression="" applyOnUpdate="0" field="description"/>
  </defaults>
  <constraints>
    <constraint notnull_strength="1" field="instrument_cat" unique_strength="1" constraints="3" exp_strength="0"/>
    <constraint notnull_strength="1" field="description" unique_strength="0" constraints="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="instrument_cat" exp="" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      <column name="instrument_cat" type="field" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField name="instrument_cat" showLabel="1" index="0"/>
  </attributeEditorForm>
  <editable>
    <field name="description" editable="1"/>
    <field name="instrument_cat" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="description" labelOnTop="0"/>
    <field name="instrument_cat" labelOnTop="0"/>
  </labelOnTop>
