...
# translation
SOURCES = sml_surveyor.py ui_sml_surveyor.py __init__.py sml_surveyordialog.py
#TRANSLATIONS = i18n/sml_surveyor_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = sml_surveyor

PY_FILES = sml_surveyor.py sml_surveyordialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_sml_surveyor.py
...
pep8:
	...
	@echo "-----------"
	@pep8 --version
	@pep8 --repeat --ignore=E203,E121,E122,E123,E124,E125,E126,E127,E128,E402
