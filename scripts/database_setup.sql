...
INSERT INTO layer_styles(f_table_catalog,f_table_schema,f_table_name,f_geometry_column,styleName,styleQML,styleSLD,useAsDefault,description,owner) VALUES (':DATABASE','public','parcel_lookup',NULL,'parcel_lookup',XMLPARSE(DOCUMENT '<!DOCTYPE qgis PUBLIC ''http://mrcc.com/qgis.dtd'' ''SYSTEM''>
	<qgis readOnly="0" minScale="1e+08" version="3.16.3-Hannover" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0">
	 <flags>
	  <Identifiable>1</Identifiable>
	  <Removable>1</Removable>
	  <Searchable>1</Searchable>
	 </flags>
	 <temporal startField="" startExpression="" endExpression="" endField="" durationUnit="min" mode="0" durationField="" fixedDuration="0" accumulate="0" enabled="0">
	  <fixedRange>
	   <start></start>
	   <end></end>
	  </fixedRange>
	 ...
	 <customproperties>
	  <property value="&quot;parcel_id&quot;" key="dualview/previewExpressions"/>
	 ...
	 <referencedLayers>
	  <relation referencedLayer="Allocation_cat_99617530_b858_4989_963c_8d45e84582d3" referencingLayer="Parcel_lookup_32b83cb4_6773_4019_8c7e_1dab1e51360e" providerKey="postgres" strength="Association" layerId="Allocation_cat_99617530_b858_4989_963c_8d45e84582d3" layerName="Allocation_cat" dataSource="dbname='':DATABASE'' host=:DB_HOST port=:DB_PORT user='':DBOWNER'' password='':DB_PASS''  key=''allocation_cat'' checkPrimaryKeyUnicity=''1'' table=&quot;public&quot;.&quot;allocation_cat&quot;" name="parcel_lookup_allocation_id_fkey" id="parcel_lookup_allocation_id_fkey">
	   <fieldRef referencingField="allocation" referencedField="allocation_cat"/>
	  </relation>
	  <relation referencedLayer="Local_govt_32ed2e26_6ebc_4588_bade_a9450f6a8e0c" referencingLayer="Parcel_lookup_32b83cb4_6773_4019_8c7e_1dab1e51360e" providerKey="postgres" strength="Association" layerId="Local_govt_32ed2e26_6ebc_4588_bade_a9450f6a8e0c" layerName="Local_govt" dataSource="dbname='':DATABASE'' host=:DB_HOST port=:DB_PORT user='':DBOWNER'' password='':DB_PASS''  key=''id'' checkPrimaryKeyUnicity=''1'' table=&quot;public&quot;.&quot;local_govt&quot;" name="parcel_lookup_local_govt_id_fkey" id="parcel_lookup_local_govt_id_fkey">
	   <fieldRef referencingField="local_govt" referencedField="id"/>
	  </relation>
	  <relation referencedLayer="Prop_types_8b9b8530_240c_4e4e_806f_be6685211f05" referencingLayer="Parcel_lookup_32b83cb4_6773_4019_8c7e_1dab1e51360e" providerKey="postgres" strength="Association" layerId="Prop_types_8b9b8530_240c_4e4e_806f_be6685211f05" layerName="Prop_types" dataSource="dbname='':DATABASE'' host=:DB_HOST port=:DB_PORT user='':DBOWNER'' password='':DB_PASS''  key=''id'' checkPrimaryKeyUnicity=''1'' table=&quot;public&quot;.&quot;prop_types&quot;" name="parcel_lookup_prop_type_id_fkey" id="parcel_lookup_prop_type_id_fkey">
	   <fieldRef referencingField="prop_type" referencedField="id"/>
	  </relation>
	  <relation referencedLayer="Schemes_0dfc058c_8e12_4e63_9c5d_1c8f5042b072" referencingLayer="Parcel_lookup_32b83cb4_6773_4019_8c7e_1dab1e51360e" providerKey="postgres" strength="Association" layerId="Schemes_0dfc058c_8e12_4e63_9c5d_1c8f5042b072" layerName="Schemes" dataSource="dbname='':DATABASE'' host=:DB_HOST port=:DB_PORT user='':DBOWNER'' password='':DB_PASS''  key=''id'' checkPrimaryKeyUnicity=''1'' table=&quot;public&quot;.&quot;schemes&quot;" name="parcel_lookup_scheme_id_fkey" id="parcel_lookup_scheme_id_fkey">
	   <fieldRef referencingField="scheme" referencedField="id"/>
	  </relation>
	  <relation referencedLayer="Status_cat_2d47ad41_1a00_4d24_8c27_8060f7a0b6ae" referencingLayer="Parcel_lookup_32b83cb4_6773_4019_8c7e_1dab1e51360e" providerKey="postgres" strength="Association" layerId="Status_cat_2d47ad41_1a00_4d24_8c27_8060f7a0b6ae" layerName="Status_cat" dataSource="dbname='':DATABASE'' host=:DB_HOST port=:DB_PORT user='':DBOWNER'' password='':DB_PASS''  key=''status_cat'' checkPrimaryKeyUnicity=''1'' table=&quot;public&quot;.&quot;status_cat&quot;" name="parcel_lookup_status_cat_fkey" id="parcel_lookup_status_cat_fkey">
	   <fieldRef referencingField="status" referencedField="status_cat"/>
	  </relation>
	 </referencedLayers>
	 <fieldConfiguration>
	   ...
	   <editWidget type="RelationReference">
	    <config>
	     <Option type="Map">
	      ...
	      <Option type="QString" value="dbname='':DATABASE'' host=:DB_HOST port=:DB_PORT user='':DBOWNER'' password='':DB_PASS''  password=''docker''  key=''id'' checkPrimaryKeyUnicity=''1'' table=&quot;public&quot;.&quot;schemes&quot;" name="ReferencedLayerDataSource"/>
	      <Option type="QString" value="schemes_422921e0_833d_4ae0_8509_d8fd7175ebd5" name="ReferencedLayerId"/>
	      <Option type="QString" value="Schemes" name="ReferencedLayerName"/>
	   ...
	   <editWidget type="RelationReference">
	    <config>
	     <Option type="Map">
	      ...
	      <Option type="bool" value="true" name="OrderByValue"/>
	      <Option type="bool" value="false" name="ReadOnly"/>
	      <Option type="QString" value="dbname='':DATABASE'' host=:DB_HOST port=:DB_PORT user='':DBOWNER'' password='':DB_PASS''  password=''docker''  key=''id'' checkPrimaryKeyUnicity=''1'' table=&quot;public&quot;.&quot;local_govt&quot;" name="ReferencedLayerDataSource"/>
	      <Option type="QString" value="local_govt_bb30d8c8_fbfa_42e6_a66d_1204c919c09e" name="ReferencedLayerId"/>
	      <Option type="QString" value="Local_govt" name="ReferencedLayerName"/>
	      <Option type="QString" value="postgres" name="ReferencedLayerProviderKey"/>
	   ...
	   <editWidget type="RelationReference">
	    <config>
	     <Option type="Map">
	      ...
	      <Option type="bool" value="true" name="OrderByValue"/>
	      <Option type="bool" value="false" name="ReadOnly"/>
	      <Option type="QString" value="dbname='':DATABASE'' host=:DB_HOST port=:DB_PORT user='':DBOWNER'' password='':DB_PASS''  password=''docker''  key=''id'' checkPrimaryKeyUnicity=''1'' table=&quot;public&quot;.&quot;prop_types&quot;" name="ReferencedLayerDataSource"/>
	      <Option type="QString" value="prop_types_b6a3cf3d_8288_4a78_b681_10a0d41203ff" name="ReferencedLayerId"/>
	      <Option type="QString" value="Prop_types" name="ReferencedLayerName"/>
	      <Option type="QString" value="postgres" name="ReferencedLayerProviderKey"/>
	   ...
	   <editWidget type="RelationReference">
	    <config>
	     <Option type="Map">
	      ...
	      <Option type="bool" value="true" name="OrderByValue"/>
	      <Option type="bool" value="false" name="ReadOnly"/>
	      <Option type="QString" value="dbname='':DATABASE'' host=:DB_HOST port=:DB_PORT user='':DBOWNER'' password='':DB_PASS''  password=''docker''  key=''allocation_cat'' checkPrimaryKeyUnicity=''1'' table=&quot;public&quot;.&quot;allocation_cat&quot;" name="ReferencedLayerDataSource"/>
	      <Option type="QString" value="allocation_cat_7a483598_2122_42ac_9b32_8d633ba6399c" name="ReferencedLayerId"/>
	      <Option type="QString" value="Allocation_cat" name="ReferencedLayerName"/>
	      <Option type="QString" value="postgres" name="ReferencedLayerProviderKey"/>
	   ...
	   <editWidget type="RelationReference">
	    <config>
	     <Option type="Map">
	      ...
	      <Option type="bool" value="true" name="OrderByValue"/>
	      <Option type="bool" value="false" name="ReadOnly"/>
	      <Option type="QString" value="dbname='':DATABASE'' host=:DB_HOST port=:DB_PORT user='':DBOWNER'' password='':DB_PASS''  password=''docker''  key=''status_cat'' checkPrimaryKeyUnicity=''1'' table=&quot;public&quot;.&quot;status_cat&quot;" name="ReferencedLayerDataSource"/>
	      <Option type="QString" value="status_cat_a4d50c7d_41bf_4d34_a102_02dd84b4a98a" name="ReferencedLayerId"/>
	      <Option type="QString" value="Status_cat" name="ReferencedLayerName"/>
	      <Option type="QString" value="postgres" name="ReferencedLayerProviderKey"/>
	 ...
	 <aliases>
	  <alias index="0" field="plot_sn" name="Plot SN"/>
	  <alias index="1" field="available" name="Availability"/>
	  <alias index="2" field="scheme" name="Scheme"/>
	  <alias index="3" field="block" name="Block"/>
	  <alias index="4" field="local_govt" name="Local overnment"/>
	  <alias index="5" field="prop_type" name="Property Type"/>
	  <alias index="6" field="file_number" name="File Number"/>
	  <alias index="7" field="allocation" name="Allocation"/>
	  <alias index="8" field="manual_no" name="Manual Number"/>
	  <alias index="9" field="deeds_file" name="Deeds File"/>
	  <alias index="10" field="parcel_id" name="Parcel Id"/>
	  <alias index="11" field="official_area" name="Official Area"/>
	  <alias index="12" field="private" name="Private"/>
	 ...
	 <constraints>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="plot_sn" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="1" notnull_strength="1" field="available" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="scheme" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="block" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="local_govt" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="prop_type" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="file_number" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="allocation" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="manual_no" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="deeds_file" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="3" notnull_strength="1" field="parcel_id" unique_strength="1"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="official_area" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="private" unique_strength="0"/>
	  <constraint exp_strength="0" constraints="0" notnull_strength="0" field="status" unique_strength="0"/>
	 </constraints>
	 <constraintExpressions>
	  <constraint exp="" desc="" field="plot_sn"/>
	  <constraint exp="" desc="" field="available"/>
	  <constraint exp="" desc="" field="scheme"/>
	  <constraint exp="" desc="" field="block"/>
	  <constraint exp="" desc="" field="local_govt"/>
	  <constraint exp="" desc="" field="prop_type"/>
	  <constraint exp="" desc="" field="file_number"/>
	  <constraint exp="" desc="" field="allocation"/>
	  <constraint exp="" desc="" field="manual_no"/>
	  <constraint exp="" desc="" field="deeds_file"/>
	  <constraint exp="" desc="" field="parcel_id"/>
	  <constraint exp="" desc="" field="official_area"/>
	  <constraint exp="" desc="" field="private"/>
	 ...
	 <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
	  <columns>
	   <column hidden="0" type="field" width="-1" name="plot_sn"/>
	   <column hidden="0" type="field" width="-1" name="available"/>
	   <column hidden="0" type="field" width="-1" name="scheme"/>
	   <column hidden="0" type="field" width="-1" name="block"/>
	   <column hidden="0" type="field" width="-1" name="local_govt"/>
	   <column hidden="0" type="field" width="-1" name="prop_type"/>
	   <column hidden="0" type="field" width="-1" name="file_number"/>
	   <column hidden="0" type="field" width="-1" name="allocation"/>
	   <column hidden="0" type="field" width="-1" name="manual_no"/>
	   <column hidden="0" type="field" width="-1" name="deeds_file"/>
	   <column hidden="0" type="field" width="-1" name="parcel_id"/>
	   <column hidden="0" type="field" width="-1" name="official_area"/>
	   <column hidden="0" type="field" width="-1" name="private"/>
	...
	def my_form_open(dialog, layer, feature):
	 ...
	 <attributeEditorForm>
	  <attributeEditorContainer columnCount="2" showLabel="1" groupBox="0" visibilityExpressionEnabled="0" visibilityExpression="" name="General">
	   <attributeEditorField index="0" showLabel="1" name="plot_sn"/>
	   <attributeEditorField index="3" showLabel="1" name="block"/>
	   <attributeEditorField index="6" showLabel="1" name="file_number"/>
	   <attributeEditorField index="8" showLabel="1" name="manual_no"/>
	   <attributeEditorField index="9" showLabel="1" name="deeds_file"/>
	   <attributeEditorField index="11" showLabel="1" name="official_area"/>
	   <attributeEditorField index="10" showLabel="1" name="parcel_id"/>
	  </attributeEditorContainer>
	  <attributeEditorContainer columnCount="1" showLabel="1" groupBox="0" visibilityExpressionEnabled="0" visibilityExpression="" name="Lookup">
	   <attributeEditorField index="12" showLabel="1" name="private"/>
	   <attributeEditorField index="2" showLabel="1" name="scheme"/>
	   <attributeEditorField index="4" showLabel="1" name="local_govt"/>
	   <attributeEditorField index="5" showLabel="1" name="prop_type"/>
	   <attributeEditorField index="7" showLabel="1" name="allocation"/>
	   <attributeEditorField index="13" showLabel="1" name="status"/>
	   <attributeEditorField index="1" showLabel="1" name="available"/>
	  </attributeEditorContainer>
	 </attributeEditorForm>
	 <editable>
	...
	'),true,'Thu Jan 21 16:33:37 2021',':DBOWNER');
